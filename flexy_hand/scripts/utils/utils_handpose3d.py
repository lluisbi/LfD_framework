# Code from:
#   Temuge Batpurev
#   https://github.com/TemugeB/handpose3d.git
...
def read_camera_parameters(camera_id):
    ...
    inf = open(rospkg.RosPack().get_path('flexy_hand') + '/scripts/camera_parameters/c' + str(camera_id) + '.dat', 'r')
...
def read_rotation_translation(camera_id):
    ...
    inf = open(rospkg.RosPack().get_path('flexy_hand') + '/scripts/camera_parameters/rot_trans_c'+ str(camera_id) + '.dat', 'r')
