# Code from:
#   Temuge Batpurev
#   https://github.com/TemugeB/python_stereo_camera_calibrate.git
...
def save_camera_intrinsics(camera_matrix, distortion_coefs, camera_name):
    ...
    out_filename = os.path.join(camera_name + '.dat')
...
def save_extrinsic_calibration_parameters(R0, T0, R1, T1, prefix = ''):
    ...
    camera0_rot_trans_filename = os.path.join(prefix + 'rot_trans_c0.dat')
    ...
    camera1_rot_trans_filename = os.path.join(prefix + 'rot_trans_c1.dat')
